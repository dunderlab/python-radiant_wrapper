...
MdTextButton.styles = [styles$12, styles$$];
...
MdOutlinedButton.styles = [styles$12, styles$_];
...
MdElevatedButton.styles = [styles$12, styles$X, styles$Y];
...
MdTonalButton.styles = [styles$12, styles$X, styles$W];
...
MdFilledButton.styles = [styles$12, styles$X, styles$V];
...
MdCheckbox.styles = [styles$U, styles$T];
...
function createFormTests(options) {
    ...
    async function setupTest(content = options.valueTests[0].render()) {
        ...
        B(x `<form>${content}</form>`, root);
        const form = root.querySelector('form');
        if (!form) {
            throw new Error('Could not query rendered <form>');
        }
        const control = options.queryControl(root);
        if (!control) {
        ...
        it(`it should pass the "${restoreTest.name}" restore test`, async () => {
            ...
            for (const control of controls) {
                ...
                const [value, state] = getInternals(control).setFormValue.calls.mostRecent()?.args ??
                    [null, null];
                const newControl = document.createElement(control.tagName);
                control.remove();
                form.appendChild(newControl);
                let restoreState = state ?? value;
 ...
 */
function createTokenTests(styles) {
 ...
 */
function getUndefinedTokens(styles) {
    let defined = new Set();
    let used = new Set();
 ...
 */
function getUnusedTokens(styles) {
    let defined = new Set();
    let used = new Set();
    for (const { styleSheet } of styles) {
        if (!styleSheet) {
    ...
    describe('forms', () => {
        createFormTests({
            ...
            valueTests: [
                {
                    name: 'unnamed',
                    render: () => x `<md-checkbox checked></md-checkbox>`,
                ...
                {
                    name: 'unchecked',
                    render: () => x `<md-checkbox name="checkbox"></md-checkbox>`,
                    assertValue(formData) {
                        expect(formData)
                ...
                },
                {
                    ...
                    render: () => x `<md-checkbox name="checkbox" checked></md-checkbox>`,
                    assertValue(formData) {
                ...
                },
                {
                    ...
                    render: () => x `<md-checkbox name="checkbox" checked value="Custom value"></md-checkbox>`,
                    assertValue(formData) {
                ...
                {
                    name: 'indeterminate',
                    render: () => x `<md-checkbox name="checkbox" checked indeterminate></md-checkbox>`,
                    assertValue(formData) {
                        expect(formData)
                ...
                {
                    name: 'disabled',
                    render: () => x `<md-checkbox name="checkbox" checked disabled></md-checkbox>`,
                    assertValue(formData) {
                        expect(formData)
            ...
            resetTests: [
                ...
                },
                {
                    ...
                    render: () => x `<md-checkbox name="checkbox" indeterminate></md-checkbox>`,
                    change(checkbox) {
...
MdAssistChip.styles = [styles$P, styles$Q, styles$R, styles$S];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$L = i$4 `.trailing.action{align-items:center;justify-content:center;padding:0 8px;--md-focus-ring-shape-start-start: var(--_container-shape-start-end);--md-focus-ring-shape-end-start: var(--_container-shape-end-end);--md-focus-ring-shape-end-end: var(--_container-shape-end-end);--md-focus-ring-shape-start-end: var(--_container-shape-start-end);--md-focus-ring-outward-offset: -2px}.trailing.action md-ripple{border-radius:50%;height:calc(1.3333333333*var(--_icon-size));width:calc(1.3333333333*var(--_icon-size))}.has-trailing .primary.action{padding-inline-end:0}.trailing.icon{color:var(--_trailing-icon-color);height:var(--_icon-size);width:var(--_icon-size)}:hover .trailing.icon{color:var(--_hover-trailing-icon-color)}:focus .trailing.icon{color:var(--_focus-trailing-icon-color)}:active .trailing.icon{color:var(--_pressed-trailing-icon-color)}.disabled .trailing.icon{color:var(--_disabled-trailing-icon-color);opacity:var(--_disabled-trailing-icon-opacity)}.selected .trailing.icon{color:var(--_selected-trailing-icon-color)}.selected:hover .trailing.icon{color:var(--_selected-hover-trailing-icon-color)}.selected:focus .trailing.icon{color:var(--_selected-focus-trailing-icon-color)}.selected:active .trailing.icon{color:var(--_selected-pressed-trailing-icon-color)}/*# sourceMappingURL=trailing-icon-styles.css.map */
`;
...
MdFilterChip.styles = [
    styles$P, styles$Q, styles$L, styles$M, styles$N,
    styles$O
];
...
MdSuggestionChip.styles = [styles$P, styles$Q, styles$J, styles$K];
...
MdInputChip.styles = [
    styles$P, styles$L, styles$M, styles$H,
    styles$I
];
...
class ChipSet extends s$2 {
    ...
    render() {
        ...
        const multiselectable = isFilter ? !this.singleSelect : A;
        return x `
      <div class="content"
          role=${role}
          aria-label=${ariaLabel || A}
...
__decorate([
    n$8({ type: Boolean, attribute: 'single-select' })
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$G = i$4 `:host{display:flex;flex-wrap:wrap;gap:8px}.content{display:flex;flex-wrap:inherit;gap:inherit}/*# sourceMappingURL=chip-set-styles.css.map */
`;
...
__decorate([
    n$8({ type: Boolean, attribute: 'reduced-touch-target' })
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$B = i$4 `@media(forced-colors: active){.fab{--md-focus-ring-outward-offset: 3px;border:1px solid ButtonText}.fab.extended{padding-inline-start:15px;padding-inline-end:19px}}/*# sourceMappingURL=forced-colors-styles.css.map */
`;
...
MdStandardIconButton.styles = [styles$t, styles$r];
...
MdLinearProgress.styles = [styles$p];
...
MdListItem.styles = [styles$n, styles$o];
...
describe('list item tests', () => {
    // TODO(b/265211574): test list item
    it('TODO', () => { });
});
 ...
 * SPDX-License-Identifier: Apache-2.0
 */
async function awaitAllListElements(root) {
...
describe('<md-list>', () => {
    ...
    it('activateNextItem activates the first item if nothing is active', async () => {
        B(x `
          <md-list>
            <md-list-item></md-list-item>
            <md-list-item></md-list-item>
    ...
    it('activatePreviousItem activates the last item if nothing is active', async () => {
        B(x `
          <md-list>
            <md-list-item></md-list-item>
            <md-list-item></md-list-item>
    ...
    it('activatePreviousItem will return null if nothing is selecatble', async () => {
        B(x `
          <md-list>
          </md-list>`, root);
        const listEl = root.querySelector('md-list');
...
MdListItemLink.styles = [styles$n, styles$o];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$k = i$4 `:host{--_list-item-selected-container-color: var(--md-menu-item-list-item-selected-container-color, var(--md-sys-color-surface-container-highest, #e6e0e9));--_list-item-container-color: var(--md-menu-item-list-item-container-color, var(--md-sys-color-surface-container, #f3edf7));--md-list-item-list-item-container-color: var(--_list-item-container-color)}:host([selected]) .list-item{background-color:var(--_list-item-selected-container-color)}.list-item:has(.submenu:hover){--md-ripple-hover-opacity: 0}/*# sourceMappingURL=menu-item-styles.css.map */
`;
...
MdMenuItemLink.styles = [styles$n, styles$k, styles$o, styles$l];
...
MdMenuItem.styles = [styles$n, styles$k, styles$o, styles$l];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$j = i$4 `@media(forced-colors: active){.menu{border-style:solid;border-color:CanvasText;border-width:1px}}/*# sourceMappingURL=forced-colors-styles.css.map */
`;
...
MdMenu.styles = [styles$i, styles$j];
MdMenu = __decorate([
    e$a('md-menu')
], MdMenu);
...
MdSubMenuItem.styles = [styles$n, styles$k, styles$o, styles$l];
...
MdRadio.styles = [styles$g, styles$h];
MdRadio = __decorate([
    e$a('md-radio')
], MdRadio);
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$d = i$4 `:host{color:unset;min-width:210px}.field{cursor:default;outline:none}.select{position:relative}.field,.select,md-menu{min-width:inherit;width:inherit;max-width:inherit}.field,.select{width:100%}:host{display:inline-flex}.label{width:100%}:host([disabled]){pointer-events:none}/*# sourceMappingURL=shared-styles.css.map */
`;
...
MdSelectOption.styles = [styles$n, styles$k, styles$o, styles$l];
    ...
    describe('forms', () => {
        createFormTests({
            ...
            valueTests: [
                {
                    name: 'unnamed',
                    render: () => x `<md-switch selected></md-switch>`,
                    assertValue(formData) {
                        expect(formData)
                            .withContext('should not add anything to form without a name')
                            .toHaveSize(0);
                ...
                {
                    name: 'unselected',
                    render: () => x `<md-switch name="switch"></md-switch>`,
                    assertValue(formData) {
                        expect(formData)
                ...
                },
                {
                    ...
                    render: () => x `<md-switch name="switch" selected></md-switch>`,
                    assertValue(formData) {
                ...
                },
                {
                    ...
                    render: () => x `<md-switch name="switch" selected value="Custom value"></md-switch>`,
                    assertValue(formData) {
                ...
                {
                    name: 'disabled',
                    render: () => x `<md-switch name="switch" selected disabled></md-switch>`,
                    assertValue(formData) {
                        expect(formData)
                            .withContext('should not add anything to form when disabled')
                            .toHaveSize(0);
...
function installSkipWebAnimations() {
    const nativeAnimate = Element.prototype.animate;
    function patchedAnimate(...args) {
        const animation = nativeAnimate.apply(this, args);
        if (animation.effect) {
            animation.effect.updateTiming({ delay: 0, duration: 1, easing: 'step-start', iterations: 1 });
        }
        return animation;
    }
